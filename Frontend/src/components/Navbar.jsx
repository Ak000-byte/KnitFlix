...
        </NavLink>
        <NavLink to='/collection' className={({ isActive }) => `flex flex-col items-center gap-1 ${isActive ? '' : ''}`}>
           <p>COLLECTION</p>
           <hr className={({ isActive }) => `w-2/4 border-none h-[1.5px] bg-gray-700 ${isActive ? 'block' : 'hidden'}`} />
        </NavLink>
         <NavLink to='/about' className={({ isActive }) => `flex flex-col items-center gap-1 ${isActive ? '' : ''}`}>
            <p>ABOUT</p>
            <hr className={({ isActive }) => `w-2/4 border-none h-[1.5px] bg-gray-700 ${isActive ? 'block' : 'hidden'}`}/>
        </NavLink>
         <NavLink to='/contact' className={({ isActive }) => `flex flex-col items-center gap-1 ${isActive ? '' : ''}`}>
            <p>CONTACT</p>
            <hr className={({ isActive }) => `w-2/4 border-none h-[1.5px] bg-gray-700 ${isActive ? 'block' : 'hidden'}`}/>
        </NavLink>
      </ul>
...
      {/*sidebar menu */}
      <div className={`absolute top-0 left-0 bottom-0 overflow-hidden bg-white transition-all z-20 ${visible ? 'w-64':'w-0'}`}>
